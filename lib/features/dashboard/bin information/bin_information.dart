...
import 'package:iot_bin_app/features/dashboard/widgets/information_row.dart';
...
class _BinInformationPageState extends State<BinInformationPage> {
  ...
  bool isDeviceOnline(Map<String, dynamic>? device) {
    ...
    final status = device['device_status']?.toString().toLowerCase();
                    ...
                    child: Column(
                      children: [
                        ...
                        BinInfoRow(
                          ...
                          title: 'Device Status',
                          value: deviceStatus?.toString() ?? 'n/a',
                        ),
                      ],
                    ),
                  ),
